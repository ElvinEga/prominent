    ...
    <div>
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-2 md:space-y-4">
                ...
                <p className="text-gray-500 leading-7">
                  The trusted supplier and distributor of Powder coating in
                  Australia. Prominent Australia Pty Ltd is a leading supplier
                  and distributor in Australia for customers who are demanding
                  high-quality powder and e-coating corrosion protection.
                </p>
                <p className="text-gray-500 leading-7">
                  Our allied product that adheres to international quality
                  standards ISO 9001:2015, ISO 14001:2015, ISO 45001:2018 and
                  IATF 16949:2016 certiﬁed company, which gives premium coating
                  shades and achieved the highest customers satisfaction.
                </p>
              </div>
              {/* End Title */}
              <div className="flex items-center space-x-4">
                <span className="text-gray-700">Follow us via</span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-12">
            ...
            <div className="border border-gray-300 rounded-lg p-6 flex flex-col h-80 items-center justify-center text-center">
              ...
              <div className="mt-3">
                ...
                <p className="mt-1 text-gray-600">
                  Suitable where maximum corrosion and chemical resistance is
                  required.
                </p>
              </div>
            </div>
            ...
            <div className="border border-gray-300 p-6 rounded-lg flex flex-col h-80 items-center justify-center text-center">
              ...
              <div className="mt-3">
                ...
                <p className="mt-1 text-gray-600">
                  A hybrid powder is a mixture of epoxy and polyester resins,
                  which forms a hard film with good resistance.
                </p>
              </div>
            </div>
            {/* End Icon Block */}
            ...
            <div className="border border-gray-300 rounded-lg p-6 flex flex-col h-80 items-center justify-center text-center">
              ...
              <div className="mt-3">
                ...
                <p className="mt-1 text-gray-600">
                  It has excellent UV resistance and suitable for exterior
                  coating.
                </p>
              </div>
            </div>
            ...
            <div className="border border-gray-300 rounded-lg p-6 flex flex-col h-80 items-center justify-center text-center">
              ...
              <div className="mt-3">
                ...
                <p className="mt-1 text-gray-600">
                  Designed for the projects that have extreme high heat
                  resistance.
                </p>
              </div>
            </div>
            ...
            <div className="border border-gray-300 rounded-lg p-6 flex flex-col h-80 items-center justify-center text-center">
              ...
              <div className="mt-3">
                ...
                <p className="mt-1 text-gray-600">
                  Alternate to polyester powder, it has polyurethanic resins
                  that gives strong protection film.
                </p>
              </div>
            </div>
            {/* End Icon Block */}
            ...
            <div className="border border-gray-300 p-6 rounded-lg flex flex-col h-80 items-center justify-center text-center">
              ...
              <div className="mt-3">
                ...
                <p className="mt-1 text-gray-600">
                  Popularly known as thermoplastic powder coating and provides
                  good thermal insulation, electrical strength and
                </p>
              </div>
            </div>
            {/* End Icon Block */}
      ...
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-24">
        ...
        <div className="mt-5 max-w-3xl text-center mx-auto">
          <p className="text-lg text-gray-600">
            Find the one that works for you from the most popular colours for
            your industry
          </p>
          <p className="text-lg text-gray-600">
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-24 mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-6">
          {/* Card */}
          <Link className="group flex flex-col focus:outline-none" href="#">
            ...
            <div className="mt-7">
              ...
              <p className="mt-3 text-2xl text-gray-800">Woodland Grey</p>
            </div>
          </Link>
          {/* End Card */}
          {/* Card */}
          ...
          >
            ...
            <div className="mt-7">
              ...
              <p className="mt-3 text-2xl text-gray-800">Antique Silver</p>
            </div>
          </Link>
          {/* End Card */}
        </div>
