...
const mockProducts: Product[] = [
  {
    ...
    price: 12.51,
    thumbnail: "/images/products/prod.png",
  },
  {
    id: "2",
    title: "BLACK MATTE CRINKLE",
    description:
    ...
    price: 9.88,
    thumbnail: "/images/products/prod2.jpg",
  },
  {
    id: "3",
    title: "PRIMERON EDGE BUFF PRIMER",
    description:
    ...
    price: 79.99,
    thumbnail: "/images/products/prod3.jpg",
  },
  {
    id: "4",
    title: "ENVIROCRON® LUM Retroreflective Black",
    description:
    ...
    price: 50.99,
    thumbnail: "/images/products/prod4.jpg",
  },
  {
    id: "5",
    title: "Transparent Candy Gold Powder ",
    description:
    ...
    price: 49.99,
    thumbnail: "/images/products/prod5.jpg",
  },
  {
    id: "6",
    title: "Tiffany Blue Powder Coat ",
    description:
    ...
    price: 20,
    thumbnail: "/images/products/prod6.jpg",
  },
];
